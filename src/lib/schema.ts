...
export const formSchema = z.object({
  ...
  travelStyle: z.enum(['Aventure / Sac à dos', 'Luxe / Détente', 'Culturel / Historique', 'Festif / Événementiel', 'Religieux / Spirituel', 'Road Trip / Van Life', 'Humanitaire / Écovolontariat'], { required_error: "Le style de voyage est obligatoire."}),
