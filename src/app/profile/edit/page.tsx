                    ...
                    <div className="space-y-6">
                        ...
                        <div className="p-6 border rounded-lg space-y-4">
                         ...
                         <div className="p-6 border rounded-lg space-y-4">
                             ...
                             <FormField control={control} name="travelStyle" render={({ field }) => (<FormItem><FormLabel>Style de voyage</FormLabel><Select onValueChange={field.onChange} value={field.value}><FormControl><SelectTrigger><SelectValue placeholder="Sélectionnez..." /></SelectTrigger></FormControl><SelectContent><SelectItem value="Aventure / Sac à dos">Aventure / Sac à dos</SelectItem><SelectItem value="Luxe / Détente">Luxe / Détente</SelectItem><SelectItem value="Culturel / Historique">Culturel / Historique</SelectItem><SelectItem value="Festif / Événementiel">Festif / Événementiel</SelectItem><SelectItem value="Religieux / Spirituel">Religieux / Spirituel</SelectItem></SelectContent></Select><FormMessage /></FormItem>)} />
