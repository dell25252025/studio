        ...
        <div className="grid min-h-screen items-center md:grid-cols-2">
            ...
            <div className="flex flex-col h-screen p-4 md:items-center md:justify-center md:h-auto">
                <div className="text-center md:hidden pt-2 flex-shrink-0">
                    ...
                    <p className="text-sm text-white px-4 leading-tight text-center md:hidden mt-2 max-w-[80%] mx-auto">
                    ...
                    <div className="w-full pb-8">
                        ...
                        <div className={`flex flex-col gap-4 ${isEmailFormVisible ? 'hidden' : 'block'} mb-10`}>
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <Button variant="link" className="text-white h-auto p-0 text-sm mt-8 mb-4" onClick={() => { setIsEmailFormVisible(true); setIsLogin(true); form.reset(); }}>
                                    Connexion
                                </Button>
                            </div>
                        </div>
