            ...
            <div className="mx-auto max-w-2xl space-y-2">
              <Card>
                ...
                <CardContent className="space-y-3 p-4 pt-0 text-xs text-muted-foreground">
                  ...
                  <h3 className="font-semibold text-foreground text-sm">2. Comment nous utilisons vos informations</h3>
                  ...
                  <h3 className="font-semibold text-foreground text-sm">3. Vos droits et choix</h3>
                  ...
                  <h3 className="font-semibold text-foreground text-sm">4. Sécurité des données</h3>
                  ...
                  <h3 className="font-semibold text-foreground text-sm">5. Nous contacter</h3>
